...
class RestaurantTableViewController: UITableViewController {
    ...
    var restaurantNames = ["Cafe Deadend", "Homei", "Teakha", "Cafe Loisl",
        ...
        "Graham Avenue Meats", "Waffle & Wolf", "Five Leaves", "Cafe Lore", "Confessional", "Barrafina", "Donostia", "Royal Oak", "Thai Cafe"]
    ...
    var restaurantTypes = ["Coffee & Tea Shop", "Cafe", "Tea House",
        "Austrian / Causual Drink", "French", "Bakery", "Bakery", "Chocolate", "Cafe",
